...
/// Entry point from dashboard — pick a Chama to manage loans.
class LoansHubScreen extends ConsumerWidget {
  const LoansHubScreen({super.key});
        ...
        builder: (context, chamas) {
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return ChamaHubTile(
                name: chama.name,
                subtitle: 'Open loan dashboard',
                icon: Icons.account_balance_wallet_outlined,
                onTap: () => context.push(RoutePaths.chamaLoans(chama.id)),
              );
            },
          );
        },
